...
public class Product extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelaHarga = new javax.swing.JLabel();
        ...
        TextKodeBarang.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        LabelNamaBarang.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LabelNamaBarang.setText("Nama Barang");

        TextNamaBarang.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        LabelaHarga.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LabelaHarga.setText("Harga");
        ...
        TextProductId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(MainPanelLayout.createSequentialGroup()
                                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(TextProductId, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(MainPanelLayout.createSequentialGroup()
                                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(LabelaHarga, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        .addGap(22, 22, 22)
                                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(TextHarga)
                                            .addComponent(TextNamaBarang, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        ...
                        .addGap(40, 40, 40)
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(LabelaHarga, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ButtonTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonTambahMouseClicked
        if( TextNamaBarang.getText().equals("") || TextHarga.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Tolong isi semua data!");
        }else{
            ProductDTO productdto = new ProductDTO();
            productdto.setProductCode(TextKodeBarang.getText());
            productdto.setProductName(TextNamaBarang.getText());
            productdto.setPrice(Integer.parseInt(TextHarga.getText()));
    ...
    private void TabelProductMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelProductMouseClicked
        ...
        int column = TabelProduct.getColumnCount();
        Object[] val = new Object[column];
        for(int i = 0; i < column; i++) {
            val[i]=TabelProduct.getValueAt(row, i);
        }
        TextProductId.setText(val[0].toString());
        TextKodeBarang.setText((String) val[1]);
        TextNamaBarang.setText((String) val[2]);
    ...
    private void ButtonEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonEditMouseClicked
        if(TabelProduct.getSelectedRow()<0){
            JOptionPane.showMessageDialog(null,"Pilih data pada tabel terlebih dahulu!");
        }else{
            ProductDTO productdto=new ProductDTO();
            if(TextKodeBarang.getText().equals("") ||TextNamaBarang.getText().equals("") || TextHarga.getText().equals("")){
                JOptionPane.showMessageDialog(null,"Tolong isi semua data!");
            }else{
                productdto.setProductId(Integer.parseInt(TextProductId.getText()));
                productdto.setProductCode(TextKodeBarang.getText());
                productdto.setProductName(TextNamaBarang.getText());
                productdto.setPrice(Integer.parseInt(TextHarga.getText()));
    ...
    private void ButtonHapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonHapusMouseClicked
        if(TabelProduct.getSelectedRow()<0){
            ...
            new ProductDAO().deleteProductDAO(((String)TabelProduct.getValueAt(TabelProduct.getSelectedRow(),1)));
            loadDatas();
        }
    ...
    public void loadDatas(){
            try{
                ...
                TabelProduct.setModel(productDAO.buildTableModel(productDAO.getQueryResult()));
    ...
    public void loadSearchProductsDatas(String text){
            try{
                ProductDAO productDAO=new ProductDAO();
                TabelProduct.setModel(productDAO.buildTableModel(productDAO.getSearchProductsQueryResult(text)));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
    ...
    private javax.swing.JLabel LabelaHarga;
