...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MenuPanelLayout.setHorizontalGroup(
            ...
            .addComponent(PanelStock, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
            .addComponent(PanelOrder, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
            .addComponent(PanelUser, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
            .addComponent(PanelLogout, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
            .addComponent(PanelPurchase, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
            .addGroup(MenuPanelLayout.createSequentialGroup()
                .addComponent(PanelPro, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 2, Short.MAX_VALUE))
            .addComponent(PanelSup, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
        ...
        jLabel2.setText("TABEL PENJUALAN HARI INI");
        ...
        jLabel1.setText("TABEL STOK BARANG HARI INI");
    ...
    public void loadDatasStock(){
            try{
                ProductDAO productDAO=new ProductDAO();
                TabelStok.setModel(productDAO.buildTableModel(productDAO.getQueryResultOfStocks()));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
    }
    
     public void loadDatasOrder(){
            try{
                OrderDAO orderDAO=new OrderDAO();
                TabelPenjualan.setModel(orderDAO.buildTableModel(orderDAO.getQueryResultNow()));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
