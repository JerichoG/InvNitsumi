...
public class Purchase extends javax.swing.JFrame {
    ...
    public Purchase() {
        ...
        TextIdPurchase.setVisible(false);
        //TextTotalHarga.setVisible(false);
        ComboSupp.removeAllItems();
        ComboSupp.addItem("Pilih Kode Supplier");
    ...
    private void initComponents() {
        ...
        TextIdPurchase = new javax.swing.JTextField();
        ...
        TabelPurchase.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Purchase", "ID Barang", "ID Supplier", "Quantity", "Harga", "Total Harga", "Tanggal"
            }
        ));
        TabelPurchase.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabelPurchaseMouseClicked(evt);
            }
        });
        ...
        LabelQuantity.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        ComboSupp.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kode Supplier" }));

        TextIdPurchase.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        TextIdPurchase.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextIdPurchaseActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(TextIdPurchase, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(MainPanelLayout.createSequentialGroup()
                                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(LabelIDSupplier, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                                    .addComponent(LabelIDBarang, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(TextTanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                                    .addComponent(ComboSupp, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel3)
                        .addComponent(TextIdPurchase, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGap(5, 5, 5)
                        .addComponent(LabelSearch))
    ...
    private void TextIdPurchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextIdPurchaseActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextIdPurchaseActionPerformed

    private void BtnClearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnClearMouseClicked
        TextIdPurchase.setText("");
        TextQuantity.setText("");
        TextHarga.setText("");
        //TextTotalHarga.setText("");
        TextTanggal.setDate(null);
        ComboProd.setSelectedIndex(0);
        ComboSupp.setSelectedIndex(0);
    ...
    private void ButtonTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonTambahMouseClicked
        ...
        if(TextTanggal.getDate()==null || TextQuantity.getText().equals("")|| TextHarga.getText().equals("")){
            ...
            String supplier=(String)ComboSupp.getSelectedItem();
            String product=(String)ComboProd.getSelectedItem();
            if("Pilih Kode Supplier".equalsIgnoreCase(supplier)||"Pilih Kode Barang".equalsIgnoreCase(product)){
                JOptionPane.showMessageDialog(null, "Isi Kode Supplier dan Kode Barang!");
            }else{
                try{
                    purchasedto.setProductCode(ComboProd.getSelectedItem().toString());
                    purchasedto.setSupplierCode(ComboSupp.getSelectedItem().toString());
                    purchasedto.setQuantity(Integer.parseInt(TextQuantity.getText()));
                    purchasedto.setPrice(Integer.parseInt(TextHarga.getText()));
                    ...
                    new PurchaseDAO().addPurchaseDAO(purchasedto);
                    loadDatas();
    ...
    private void TextSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextSearchKeyReleased
        ...
        loadSearchPurchasesDatas(text);
    }//GEN-LAST:event_TextSearchKeyReleased

    private void TabelPurchaseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelPurchaseMouseClicked
        int row = TabelPurchase.getSelectedRow();
        int column = TabelPurchase.getColumnCount();
        Object[] val = new Object[column];
        for(int i = 0; i < column; i++) {
            val[i]=TabelPurchase.getValueAt(row, i);
        }
        
        TextIdPurchase.setText(val[0].toString());
        ComboSupp.setSelectedItem(val[1]);
        ComboProd.setSelectedItem(val[2]);
        TextQuantity.setText(val[3].toString());
        TextHarga.setText(val[4].toString());
        TextTanggal.setDate(null);
    }//GEN-LAST:event_TabelPurchaseMouseClicked

    private void ButtonHapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonHapusMouseClicked
        PurchaseDTO purchasedto=new PurchaseDTO();
        if(TabelPurchase.getSelectedRow()<0){
            ...
            try{
                ...
                purchasedto.setQuantity(Integer.parseInt(TextQuantity.getText()));    
                purchasedto.setProductCode(ComboProd.getSelectedItem().toString());
                new PurchaseDAO().editstock(purchasedto);
                new PurchaseDAO().deletePurchaseDAO(TabelPurchase.getValueAt(TabelPurchase.getSelectedRow(),0).toString());
                loadDatas();
    ...
    private void TextQuantityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextQuantityKeyReleased
        PurchaseDTO purchasedto=new PurchaseDTO();
        purchasedto.setQuantity(Integer.parseInt(TextQuantity.getText()));
        new PurchaseDAO().MaxStock(purchasedto);
    }//GEN-LAST:event_TextQuantityKeyReleased

    public void suppliersCode(){
        ResultSet rs= new PurchaseDAO().getSupplierCode();
        try{
            while(rs.next()){
                String suppliersCode=rs.getString("Kode_Supplier");
                ComboSupp.addItem(suppliersCode);
            }
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void productsCode(){
        ResultSet rs= new PurchaseDAO().getProductCode();
        try{
            while(rs.next()){
    ...
    public void loadDatas(){
            try{
                ...
                TabelPurchase.setModel(purchaseDAO.buildTableModel(purchaseDAO.getQueryResult()));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
    public void loadSearchPurchasesDatas(String text){
            try{
                PurchaseDAO purchaseDAO=new PurchaseDAO();
                TabelPurchase.setModel(purchaseDAO.buildTableModel(purchaseDAO.getSearchPurchasesQueryResult(text)));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
    ...
    private javax.swing.JComboBox<String> ComboSupp;
    ...
    private javax.swing.JTextField TextIdPurchase;
