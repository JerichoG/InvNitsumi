...
public class User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (TabelUser.getColumnModel().getColumnCount() > 0) {
            TabelUser.getColumnModel().getColumn(0).setMinWidth(20);
            TabelUser.getColumnModel().getColumn(0).setPreferredWidth(20);
            TabelUser.getColumnModel().getColumn(0).setMaxWidth(25);
        }
        ...
        TextSearchUser.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        TextSearchUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextSearchUserActionPerformed(evt);
            }
        });
        TextSearchUser.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TextSearchUserKeyReleased(evt);
            }
        });

        LabelToko.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        LabelToko.setText("Username");
        ...
        TextUserId.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        LabelHP.setText("Posisi");

        TextPosisi.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        TextPosisi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextPosisiActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(TextSearchUser, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(MainPanelLayout.createSequentialGroup()
                                .addGap(34, 34, 34)
                                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(TextUsername, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                                    .addComponent(TextPassword)
                                    .addComponent(TextPosisi)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(TextSearchUser, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void TextSearchUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextSearchUserActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextSearchUserActionPerformed
    ...
    private void TextPosisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextPosisiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextPosisiActionPerformed
    ...
    private void TabelUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelUserMouseClicked
        ...
        int column = TabelUser.getColumnCount();
        Object[] val = new Object[column];
        for(int i = 0; i < column; i++) {
            val[i]=TabelUser.getValueAt(row, i);
        }
       TextUserId.setText(val[0].toString());
        TextUsername.setText((String) val[1]);
        //TextPassword.setText((String) val[2]);
        TextPosisi.setText((String) val[3]);
    ...
    private void ButtonHapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonHapusMouseClicked
        if(TabelUser.getSelectedRow()<0){
            ...
            new UserDAO().deleteUserDAO(String.valueOf(TabelUser.getValueAt(TabelUser.getSelectedRow(),1)));
            loadDatas();
        }
    ...
    private void ButtonTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonTambahMouseClicked
        if(TextUsername.getText().equals("") || TextPassword.getText().equals("") || TextPosisi.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Tolong isi semua data!");
        }else{
            UserDTO userdto=new UserDTO(); 
            userdto.setUsername(TextUsername.getText());
            userdto.setPassword(TextPassword.getText());
            userdto.setPosisi(TextPosisi.getText());           
    ...
    private void ButtonEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonEditMouseClicked
        if(TabelUser.getSelectedRow()<0){
            ...
            if(TextUsername.getText().equals("") || TextPassword.getText().equals("") || TextPosisi.getText().equals("")){
                ...
                userdto.setId(Integer.parseInt(TextUserId.getText()));
                userdto.setUsername(TextUsername.getText());
                userdto.setPassword(TextPassword.getText());
                userdto.setPosisi(TextPosisi.getText());              
    ...
    private void TextSearchUserKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextSearchUserKeyReleased
        String text=TextSearchUser.getText();
        loadSearchUsersDatas(text);
    }//GEN-LAST:event_TextSearchUserKeyReleased
    
    public void loadDatas(){
            try{
                UserDAO userDAO=new UserDAO();
                TabelUser.setModel(userDAO.buildTableModel(userDAO.getQueryResult()));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
    
    public void loadSearchUsersDatas(String text){
            try{
                UserDAO userDAO=new UserDAO();
                TabelUser.setModel(userDAO.buildTableModel(userDAO.getSearchUsersQueryResult(text)));
            }catch(SQLException ex){
                ex.printStackTrace();
            }
        }
    ...
    private javax.swing.JTextField TextPosisi;
